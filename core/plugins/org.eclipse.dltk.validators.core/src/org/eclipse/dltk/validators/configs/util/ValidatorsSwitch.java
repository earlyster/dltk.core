 ...
 * </copyright>
 *
 * $Id: ValidatorsSwitch.java,v 1.1 2009/02/27 09:14:25 apanchenk Exp $
 */
 ...
 * @generated
 */
public class ValidatorsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ValidatorsPackage.VALIDATOR_CONFIG: {
				ValidatorConfig validatorConfig = (ValidatorConfig)theEObject;
				T result = caseValidatorConfig(validatorConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ValidatorsPackage.VALIDATOR_ENVIRONMENT_INSTANCE: {
				ValidatorEnvironmentInstance validatorEnvironmentInstance = (ValidatorEnvironmentInstance)theEObject;
				T result = caseValidatorEnvironmentInstance(validatorEnvironmentInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ValidatorsPackage.VALIDATOR_INSTANCE: {
				ValidatorInstance validatorInstance = (ValidatorInstance)theEObject;
				T result = caseValidatorInstance(validatorInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
