...
public class Strings {
	...
	// {
	// return IndentManipulation.measureIndentUnits(line, CodeFormatterUtil
	// .getTabWidth(project), CodeFormatterUtil
	...
	// CodeFormatterUtil.getTabWidth(project), CodeFormatterUtil
	// .getIndentWidth(project));
	// }
	...
	// {
	// return IndentManipulation.extractIndentString(line, CodeFormatterUtil
	// .getTabWidth(project), CodeFormatterUtil
	// .getIndentWidth(project));
	// }
	...
	// CodeFormatterUtil.getTabWidth(project), CodeFormatterUtil
	// .getIndentWidth(project), newIndent, lineDelim);
	// }
	...
	// }
	//
	// public static String trimIndentation(String source, IScriptProject
	// project,
	// boolean considerFirstLine) {
