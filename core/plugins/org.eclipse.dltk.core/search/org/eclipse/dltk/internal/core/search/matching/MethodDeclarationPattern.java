...
public class MethodDeclarationPattern extends DLTKSearchPattern implements
	...
	public MethodDeclarationPattern(char[] pkg, char[] simpleName,
			char methodSuffix, int matchRule, IDLTKLanguageToolkit toolkit) {
	...
	protected StringBuffer print(StringBuffer output) {
		switch (this.methodSuffix) {
		case TYPE_SUFFIX:
			output.append("MethodDeclarationPattern: pkg<"); //$NON-NLS-1$
			break;
		case ANNOTATION_TYPE_SUFFIX:
